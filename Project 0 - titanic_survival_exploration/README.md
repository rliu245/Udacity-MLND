Summary: In this project, I was tasked with finishing the exercises on the jupyter notebook. Within the exercises, I was tasked with manually separating data based on features that I believed had an impact on whether someone survived the titanic or not. The exercise provided me with an opportunity to understand how classification algorithms worked on a high level. 
